...
\R{} and \Bioconductor{}, by Michael Lawrence and Martin Morgan, 
\url{http://www.imstat.org/sts/future_papers.html} 
reviews these strategies and implementation in \Bioconductor{}. Problem 
areas include scalable processing, summarization and visualization. 
Presented techniques are well-established and include restricting queries, 
