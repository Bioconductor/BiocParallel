...
.lapply_reducer <- BiocParallel:::.lapply_reducer
.iterate_reducer <- BiocParallel:::.iterate_reducer
...
test_reducer_iterate_1 <- function() {
    r <- .iterate_reducer(reduce.in.order=TRUE,
                         reducer = NULL)
...
test_reducer_iterate_2 <- function() {
    r <- .iterate_reducer(`+`, init=0, reduce.in.order=TRUE,
                                         reducer = NULL)
...
test_reducer_iterate_3 <- function() {
    r <- .iterate_reducer(`+`, init=0, reduce.in.order=FALSE,
                         reducer = NULL)
    checkIdentical(0, .reducer_value(r))
...
test_reducer_iterate_4 <- function() {
    r <- .iterate_reducer(function(x,y)NULL, init=NULL,
